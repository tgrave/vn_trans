...
class ScenariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scenario" do
    assert_difference('Scenario.count') do
      post scenarios_url, params: { scenario: { filename: @scenario.filename, lines: @scenario.lines, name: @scenario.name, translated: @scenario.translated } }
    end
  ...
  test "should update scenario" do
    patch scenario_url(@scenario), params: { scenario: { filename: @scenario.filename, lines: @scenario.lines, name: @scenario.name, translated: @scenario.translated } }
