...
class LinesTest < ApplicationSystemTestCase
  ...
  test "creating a Line" do
    ...
    fill_in "Content translated", with: @line.content_translated
    fill_in "Fragment", with: @line.fragment_id
    fill_in "Updated by", with: @line.updated_by
    fill_in "Who", with: @line.who
    fill_in "Who translated", with: @line.who_translated
